      ...
      <div class="row section-separator">
         ...
         <div class="col-sm-12 col-md-4">
            <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
               <img src="http://cvresumetemplate.com/maha-personal-cv-resume-html-template/assets/images/b-3.png" alt="" class="img-fluid">
         ...
         <div class="col-sm-12 col-md-4">
            <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
               <img src="http://cvresumetemplate.com/maha-personal-cv-resume-html-template/assets/images/b-2.png" alt="" class="img-fluid">
               <div class="blog-inner">
         ...
         <div class="col-sm-12 col-md-4">
            <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
               <img src="http://cvresumetemplate.com/maha-personal-cv-resume-html-template/assets/images/b-1.png" alt="" class="img-fluid">
               <div class="blog-inner">
