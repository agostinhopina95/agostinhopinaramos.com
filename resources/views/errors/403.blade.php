...
<link rel='stylesheet' href="@php echo return_path(Request::path()) . '/css/style-error.min.css'; @endphp" type='text/css' />
</x-Header>
...
<main class="main">
    ...
    <div class="e-message">
        <p>403 - Error. Forbidden.</p>
        <span>Sorry, you don't have permission to access this page: <strong>{{ Request::path() }}</strong>.</span>
        <br><br>
        <center>
        <a class="btn btn-fill" href="/"><i class="fa fa-home"></i>&nbsp; Home</a>
        </center>
    </div>
</main>
